...
#ifndef ISIMPLEADDRESSLOOKUP_H
#define ISIMPLEADDRESSLOOKUP_H

#include "utils/coordinates.h"
#include <QtPlugin>
#include <QVector>

class ISimpleAddressLookup
{
public:
	virtual ~ISimpleAddressLookup() {}
...
Q_DECLARE_INTERFACE( ISimpleAddressLookup, "monav.ISimpleAddressLookup/1.2" )

#endif // ISIMPLEADDRESSLOOKUP_H
