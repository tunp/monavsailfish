...
#ifndef SIMPLEUNICODETOURNAMENTTRIECLIENT_H
#define SIMPLEUNICODETOURNAMENTTRIECLIENT_H
...
class SimpleUnicodeTournamentTrieClient : public QObject, public ISimpleAddressLookup
{
	Q_OBJECT
	Q_INTERFACES( ISimpleAddressLookup )
	Q_PLUGIN_METADATA(IID "monav.ISimpleAddressLookup/1.2")
public:

	 explicit SimpleUnicodeTournamentTrieClient();
	 ~SimpleUnicodeTournamentTrieClient();
